      ...
      <Container className="tw-py-28">
        <div className="tw-flex tw-gap-x-[60px]">
          ...
          <div className="tw-w-1/2">
            ...
            <div className="tw-flex tw-items-center tw-gap-x-3 !tw-border-y !tw-border-white tw-py-6">
              <div>
                <FontAwesomeIcon
                  size="xl"
                  icon={faPaw}
            ...
            <h4></h4>
            <div className="tw-space-y-8 tw-rounded-2xl tw-bg-white tw-px-10 tw-py-14 tw-text-center">
